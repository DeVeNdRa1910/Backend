...
const storage = multer.diskStorage({
    ...
    filename: function (req, file, cb) {
        ...
        //our method to generat eunique name
            crypto.randomBytes(12, (err, bytes) => {
                const fn = bytes.toString("hex") + path.extname(file.originalname);
                cb(null, fn)
            })
        
        // path.extname() will add extension name
...
//multer req me do cheej provide karta hai body and file jo image ham upload karte  hai vo req.file me hogi and text field ka data req.body me hoga
